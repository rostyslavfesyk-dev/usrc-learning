                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <span
                      className={
                        isUI
                          ? "inline-flex items-center rounded-pill bg-usrc-crimson/10 px-2.5 py-1 text-xs font-medium uppercase tracking-wider text-usrc-crimson"
                          : "inline-flex items-center rounded-pill bg-usrc-navy/10 px-2.5 py-1 text-xs font-medium uppercase tracking-wider text-usrc-navy"
                      }
                    >
                      {t.category}
                    </span>
                    <RiArrowRightUpLine
                      aria-hidden="true"
                      size={18}
                      className="shrink-0 text-usrc-crimson"
                    />
                  </div>
